<#
	...
	.SYNOPSIS
		This script automates the generation of certificates for VMware Workspace One Access, formerly know as Identity manager. This includes generating all certificates
...
$IdentityManagerNAME = "hamvidm01" #Short name for your IdentityManager VIP or single node (not FQDN)
...
#$IdentityManagerDNS1 = "vidm01.hamker.local" #Node 1 FQDN 	#Note, If you have multiple WOA applainces, uncomment this and fill in the variable
#$IdentityManagerIP1 = "192.168.1.181" #Node 1 IP 			#Note, If you have multiple WOA applainces, uncomment this and fill in the variable
#$IdentityManagerDNS2 = "vidm02.hamker.local" #Node 2 FQDN 	#Note, If you have multiple WOA applainces, uncomment this and fill in the variable
#$IdentityManagerIP2 = "192.168.1.182" #Node 2 IP 			#Note, If you have multiple WOA applainces, uncomment this and fill in the variable
#$IdentityManagerDNS3 = "vidm03.hamker.local" #Node 3 FQDN 	#Note, If you have multiple WOA applainces, uncomment this and fill in the variable
#$IdentityManagerIP3 = "192.168.1.183" #Node 3 IP 			#Note, If you have multiple WOA applainces, uncomment this and fill in the variable

#Standard Variables
$CERTLOCATION = "C:\Certs"
$IdentityManagerCertLocationGet = Get-Item "$CERTLOCATION\WOA\$IdentityManagerFQDN" -ErrorAction SilentlyContinue
$IdentityManagerCertLocation = "$CERTLOCATION\WOA\$IdentityManagerFQDN"
